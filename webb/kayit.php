                   ...
                   <header>Kayıt ol</header>
                    <form action="" method="post">
                        ...
                        <div class="field input">
                            ...
                            <input type="text" name="username" id="username" autocomplete="off"  min="1" required>
                        </div>

                        <div class="field input">

                            <label for="email">Email: </label>
                            <input type="text" name="email" id="email" autocomplete="off"  min="1" required>
                        </div>

                        <div class="field input">

                            <label for="password">Şifre: </label>
                            <input type="password" name="password" id="password" autocomplete="off"  min="1" required>
                        </div>
